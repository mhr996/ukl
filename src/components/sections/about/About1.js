            ...
            >
              ...
              <div className="box-area">
                <div
                  ...
                  data-wow-delay=".3s"
                >
                  <span className="sub-title">Established</span>
                  <div className="customers-number">1998</div>
                  <h6 className="customers-text">
                    Leading Kuwaiti multinational company
                  </h6>
                </div>
              </div>
            </div>
            ...
            >
              <div className="sec-heading">
                ...
                <h2 className="sec-title title-anim">
                  We Keep Complex Programs Moving with Dependable Support Across
                  the <span>GCC.</span>
                </h2>
              </div>
              ...
              >
                ...
                <div className="client-info-area">
                  <div className="client-info">
                    <h6 className="title">United Kuwait Land</h6>
                    <span className="designation">Est. 1998</span>
                  </div>
