...
const ServicesDetailsPrimary = ({ option }) => {
	...
	const { title, titleLarge, id, iconName, img, desc1, desc2, img2, img3, process } = currentItem || {};
	const sidebarItems = items?.slice(0, 6);
	const processItems = process?.processItems || [];
	return (
					...
					<div className="col-lg-8">
						<div className="post-details-wrapper">
							<div className="blog-images wow fadeInUp" data-wow-delay=".1s">
								<Image
									src={process?.img || "/images/service/service-details.webp"}
									alt="Images"
									width={870}
									height={450}
									style={{ height: "auto" }}
							...
							<div className="blog-text">
								...
								<p className="wow fadeInUp" data-wow-delay=".3s">
									At UKL, we don't just focus on solving customer problems—we
